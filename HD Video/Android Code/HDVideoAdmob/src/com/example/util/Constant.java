...
public class Constant implements Serializable{
	...
	private static final long serialVersionUID = 1L;
		...
		public static final String SERVER_IMAGE_UPFOLDER="http://viaviweb.in/Apps/hdvideo_client/images/thumbs/";
		...
		public static final String LATEST_URL = "http://viaviweb.in/Apps/hdvideo_client/api.php?latest=15";
		//this url gives list of category in 2nd tab
		public static final String CATEGORY_URL = "http://viaviweb.in/Apps/hdvideo_client/api.php";
		//this url gives item of specific category.
		public static final String CATEGORY_ITEM_URL = "http://viaviweb.in/Apps/hdvideo_client/api.php?cat_id=";
		
	    public static final String SERVER_IMAGE_UPFOLDER_OWN="http://viaviweb.in/Apps/hdvideo_client/images/";
